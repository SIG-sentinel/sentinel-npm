...
use crate::constants::{
    ...
    OUTPUT_REASON_PROVENANCE_ANOMALOUS, OUTPUT_REASON_PROVENANCE_INCONSISTENT,
    OUTPUT_REASON_PROVENANCE_MISSING, OUTPUT_REASON_REGISTRY_OFFLINE,
    OUTPUT_REASON_REGISTRY_TIMEOUT, OUTPUT_REASON_TARBALL_TOO_LARGE, OUTPUT_STATUS_ALL_CLEAN,
    OUTPUT_STATUS_BLOCKED, OUTPUT_STATUS_WARNINGS, OUTPUT_SUMMARY_LINE_TEMPLATE,
    OUTPUT_SYMBOL_WARNING, UI_LABEL_NEXT, UI_LABEL_TIP, render_template, render_with_error,
};
use crate::types::{
...
fn unverifiable_reason_text(reason: UnverifiableReason) -> &'static str {
    match reason {
        ...
        UnverifiableReason::ProvenanceAnomalous => OUTPUT_REASON_PROVENANCE_ANOMALOUS,
    }
}
