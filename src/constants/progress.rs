...
pub const CHECK_PROGRESS_TEMPLATE: &str =
    "  {spinner:.cyan} {msg:<20} [{wide_bar:.cyan/blue}] {pos:>4}/{len:<4} elapsed {elapsed_precise}";
pub const CHECK_PROGRESS_VERIFY_MSG: &str = "verifying packages";
pub const INSTALL_PROGRESS_TEMPLATE: &str =
    "  {spinner:.cyan} {msg:<24} [{wide_bar:.cyan/blue}] {pos:>4}/{len:<4} elapsed {elapsed_precise} eta {eta_precise}";
