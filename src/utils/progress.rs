...
use crate::types::{OutputFormat, ProgressBarConfig, ShouldRenderProgressBarParams};
...
pub fn should_render_progress_bar(params: ShouldRenderProgressBarParams<'_>) -> bool {
    let ShouldRenderProgressBarParams {
        output_format,
        quiet,
    } = params;
